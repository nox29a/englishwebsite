    ...
    <div className="bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white min-h-screen flex flex-col">
      ...
      >
        {[
          ...
          >
            <Icon className="h-12 w-12 text-indigo-600 mb-4 group-hover:text-yellow-400 transition-colors" />
        ...
        {[
          {
            ...
            title: "Fiszki",
            description:
              "Szybkie powtarzanie najważniejszych słówek na różnych poziomach.",
          },
          {
            href: "/trener-slowek",
            icon: Brain,
            title: "Trener słówek",
            description:
              "Interaktywny trener, który pomoże Ci szybko zapamiętać nowe słowa.",
          },
          {
            href: "/trener-nieregularnych",
            icon: Repeat,
            title: "Trener czasowników nieregularnych",
            description:
              "Nauka i ćwiczenia nieregularnych form czasowników angielskich.",
          },
      ...
      >
        ...
        <div className="space-y-6 max-w-3xl mx-auto">
          <details className="bg-indigo-50 dark:bg-indigo-900 p-4 rounded-lg cursor-pointer">
            <summary className="font-semibold text-lg">Jak działa poziom trudności?</summary>
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              Poziomy oparte są na najczęściej używanych słowach i strukturach, dzięki czemu uczysz się dokładnie tego, co najbardziej się przyda.
            </p>
          </details>
          <details className="bg-indigo-50 dark:bg-indigo-900 p-4 rounded-lg cursor-pointer">
            <summary className="font-semibold text-lg">Czy korzystacie z AI?</summary>
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              Tak! Nasza sztuczna inteligencja personalizuje materiały i tempo nauki, byś osiągnął najlepsze wyniki.
            </p>
          </details>
          <details className="bg-indigo-50 dark:bg-indigo-900 p-4 rounded-lg cursor-pointer">
            <summary className="font-semibold text-lg">Czy strona jest responsywna?</summary>
            <p className="mt-2 text-gray-700 dark:text-gray-300">
              Oczywiście — działa świetnie na telefonach, tabletach i desktopach.
            </p>
          </details>
        </div>
      </section>
