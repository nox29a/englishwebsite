...
function StatCard({ title, icon, children }: {
  ...
  return (
    <div className="rounded-3xl p-6 backdrop-blur-xl transition-transform duration-300 hover:scale-[1.02] hover:bg-white/10 h-full shadow-[0_20px_45px_rgba(15,23,42,0.35)] bg-white/5 border border-white/10">
